console.log(`---------------Creating map collection and traverse using forEach() loop----------------------------`);
console.log(``);
...
console.log(``);
console.log(`----------------------------------------------------------------------------------------`);
console.log(`2.)  employee with salary greater than or equal to 50000`);
employees.forEach( (employee) => {
...
console.log(`5.  IT or HR dept employee whose salary is greater than or equal to 75000`);
employees.forEach( (employee) => {
